    ...
    if listDisaggregatedRecords:
        for camId in setCameraId:
            ...
            if listFiltered:
                ...
                listRecordAtributosIn.append(getInfoCam(camId)+tuple(['ins',malesIn,femalesIn])+tuple(cnt_malesIn)+tuple(cnt_femalesIn))

    listDisaggregatedRecords.clear()
    setCameraId.clear()
    return listRecordFlujo,listRecordAtributosIn
